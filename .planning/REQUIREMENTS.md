...
- [x] **FOUND-04**: DBTools_SQL LINQ-first data access (no EF Core in Reborn)
...
| UI-01–02 | Phase 7 | `fix-design-system` | In Progress (70/74) |
| UI-03 | Phase 8 | `mockup-visual-parity` | Pending |
| UI-04 | Phase 8 | `2-mockup-functional-fixes` | Pending |
| UI-05 | Phase 7 | `2 - visual-design-system` | Pending |
| DASH-01–02 | Phase 9 | `dashboard` | Pending |
| DASH-03 | Phase 9 | `occupied-apartments-bug` | Pending |
| DASH-04 | Phase 9 | `vehicle-edit` | Pending |
| DEMO-01–02 | Phase 10 | `4 - demo-mode` | Pending |
| PHOTO-01–02 | Phase 11 | `3 - photo-capture-hardware-integration` | Deferred (v2) |
| CI-01–04 | Phase 12 | `1 - modernization-roadmap` C.1–C.7 | Pending |
| ARCH-01–02 | Phase 13 | `1 - modernization-roadmap-arm64` | Deferred (v2) |
...
*Last updated: 2026-06-24 after initialization from `.specs/`*
