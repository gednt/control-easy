...
- [x] **Phase 7: DBTools NuGet Migration (INSERTED)** — Replace `src/lib/DBTools_SQL/` with [DBTools 1.4.3](https://www.nuget.org/packages/DBTools) ✅
- [x] **Phase 8: Design System Hardening** — Token unification, component refactors, formal spec gap-fill *(was Phase 7)*
- [ ] **Phase 9: UI Parity & Functional Fixes** — Mockup visual parity + interaction fixes *(deferred to v1.1: UI-03, UI-04)*
- [x] **Phase 10: Dashboard & Quick Wins** — v1.0 DASH-03 bugfix complete; DASH-01, DASH-02, DASH-04 deferred to v1.1
- [x] **Phase 11: Demo Mode** — One-command seeded evaluation stack
- [ ] **Phase 12: Photo Capture & Hardware** — Photos module + hardware framework *(v2)*
- [x] **Phase 13: Continuous Engineering** — CI pipeline, cross-tenant tests, tokens contract
...
- `.specs/fix-design-system/` — **74/74**
- `.specs/2 - visual-design-system/` — **64/64**
...
- [x] 08-01: Complete fix-design-system verification gate (tasks 12.5–12.8)
- [x] 08-02: Close remaining formal visual-design-system spec gaps
...
**Requirements**: DASH-03 (v1.0); DASH-01, DASH-02, DASH-04 deferred to v1.1
**Plans**: 3 plans

Plans:

- [ ] 10-01: Dashboard live stats (deferred to v1.1)
- [x] 10-02: Occupied-apartments bugfix
- [ ] 10-03: Vehicle edit UI (deferred to v1.1)
...
**Spec**: `.specs/1 - modernization-roadmap/` C.1–C.7 — 7/7
**Requirements**: CI-01–04
**Plans**: 2 plans

Plans:

- [x] 13-01: GitHub Actions CI pipeline
- [x] 13-02: Architecture guardrails + doc sync
...
| 8. Design System | `fix-design-system`, `2 - visual-design-system` | 138/138 | ✅ Complete | 2026-07-12 |
| 9. UI Parity & Fixes | 2 specs | 0/86 | Deferred (v1.1) | — |
| 10. Dashboard & Quick Wins | `occupied-apartments-bug` + deferred specs | v1.0 scope complete | ✅ Complete (v1.0 scope) | 2026-07-12 |
...
| 13. Continuous Engineering | C.1–C.7 | 7/7 | ✅ Complete | 2026-07-12 |
| 14. Multi-Arch | `1 - modernization-roadmap-arm64` | 0/8 | Deferred (v2) | — |

---
*Roadmap updated: 2026-07-12 — v1.0 active scope complete; deferred scope retained for v1.1/v2*
*Current focus: v1.0 milestone audit and completion*
