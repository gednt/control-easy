...
- [x] **1.** Fix the `occupiedApartments` raw SQL query in `ReportReadRepository.cs` to include aliased tenant filters, bypassing the interceptor's ambiguous injection
...
- [x] **2.** Add unit/integration test for `occupiedApartments` counting
...
- [x] **3.** Rebuild Docker stack and verify
