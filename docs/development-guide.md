...
Canonical home for the content below: see `AGENTS.md` "Local
development" (§ 4) and the relevant `.planning/codebase/*.md` map.

Do NOT update this file; update the canonical home. The retirement
of this file is gated on the next `/gsd-complete-milestone` run.
-->
